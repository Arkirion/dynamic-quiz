      ...
      <div className="flex w-full">
        <div className="relative flex flex-grow items-center">
          ...
          <button
            ...
            className="text-black  absolute right-2.5 bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex justify-center">
            <span className="mr-2 leading-6 tracking-widest">Validar</span>
